...
public class Dialog extends android.app.Dialog {
    ...
    public Dialog(Context context, String title, String message, String cancelTitle, String appectTitile) {
        super(context, android.R.style.Theme_Translucent);
        this.context = context;// init Context
        this.message = message;
        this.title = title;
        this.cancelTitle = cancelTitle;
        this.appectTitile = appectTitile;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.buttonAccept.setText(appectTitile);
        ...
        this.buttonCancel.setText(cancelTitle);
