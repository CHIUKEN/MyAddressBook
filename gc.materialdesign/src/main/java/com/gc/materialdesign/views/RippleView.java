...
public abstract class RippleView extends CustomView{
	...
	protected int rippleSize = 3;//����找辣銝�鈭抒���敶Ｘ�瞍芰�憭批�
	...
	protected void setRippleAttributes(AttributeSet attrs) {
		...
		if(color != -1){
			...
			int rColor = attrs.getAttributeIntValue(MATERIALDESIGNXML, "rippleColor", -1);// 16餈����			
	...
	/**
	 * 霈曄蔭隞���嗅����孵鈭辣嚗�����餃停�詨�嚗��舐�瘨憚�拇摰���
