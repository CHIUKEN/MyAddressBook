            ...
            mMaterialDialog.setTitle("MaterialDialog")
                    ...
                    .setPositiveButton(
                            "OK", new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Toast.makeText(Test2Activity.this, "Ok", Toast.LENGTH_LONG).show();
                    ...
                    .setNegativeButton(
                            "CANCLE", new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    mMaterialDialog.dismiss();
                                    Toast.makeText(Test2Activity.this, "Cancle", Toast.LENGTH_LONG).show();
                                }
                            }
                    )
                    ...
                    .setOnDismissListener(
                            new DialogInterface.OnDismissListener() {
                                ...
                                public void onDismiss(DialogInterface dialog) {
                                    Toast.makeText(Test2Activity.this, "onDismiss", Toast.LENGTH_SHORT).show();
                                }
                            }
                    )
                    .show();
